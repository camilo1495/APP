                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?php echo $apellidos; ?>" name="apellidos"
                                id="apellidos" aria-describedby="helpId" placeholder="Apellidos">
                        ...
                        <div class="mb-3">
                            ...
                            <select multiple class="form-control" name="cursos[]" id="ListaCursos">
                                ...
                                <?php foreach ($listaCursos as $curso): ?>
                                    ...
                                    <option <?php if (!empty($arregloCursos)):
                                        if (in_array($curso["id"], $arregloCursos)): ?>
                                                selected <?php endif; endif; ?> value="<?php echo $curso["id"]; ?>">
                                        <?php echo $curso["nombre_curso"]; ?></option>
                                <?php endforeach; ?>
                    ...
                    <?php foreach ($alumnos as $alumno) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                <?php
                                foreach ($alumno["cursos"] as $curso) { ?>- <a
                                        href="certificado.php?idcurso=<?php echo $curso["id"]; ?>&idalumno=<?php echo $alumno["id"]; ?>">
